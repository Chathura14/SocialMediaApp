...
const PostsList = ({
  ...
  return (
      ...
      >
        <div className="border bg-white max-w-screen-md mt-6 rounded-2xl p-4 " style={{  border: "2px solid #FF0404" }}>
          <div className="flex items-center	justify-between">
            <div className="gap-3.5	flex items-center ">
              ...
              <div className="flex flex-col">
                <b className="mb-2 capitalize text-neutral-700">{post?.username}</b>
                <time datetime="06-08-21" className="text-neutral-200 text-xs">
                  <TimeAgo date={post?.date} />
                </time>
              </div>
            </div>
            <div className="bg-white	rounded-full h-3.5 flex	items-center justify-center gap-3">
              {user?.id === post?.userId && (
                <>
                  <AiFillDelete
                    size={20}
          ...
          <div className="whitespace-pre-wrap mt-7 font-bold text-neutral-700 ">
            {post?.title}
          </div>
          <p className="mt-1 text-sm text-neutral-700">{post?.description}</p>
          ...
          <div className=" h-16 border-b  flex items-center justify-around	">
            <div className="flex items-center	gap-3	cursor-pointer">
              ...
              <p className="text-neutral-700"> {post?.likeCount} Like</p>
            </div>
            <div
            ...
            >
              ...
              <p className="text-neutral-700 ">{post?.comments?.length} Comment</p>
            </div>
            ...
            >
              ...
              <p className="text-neutral-700"> Share</p>
            </div>
          </div>
        </div>
                          ...
                          <div className="flex gap-5">
                            <div className="flex justify-center items-center">
                              <img
                                ...
                                alt=""
                                className="object-cover bg-red-500 rounded-full w-14 h-14"
                              />
                            </div>
                            <div className="flex flex-col">
