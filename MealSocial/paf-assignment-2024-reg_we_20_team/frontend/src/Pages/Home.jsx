...
const Home = () => {
  ...
  <TETabs fill className="">
    <TETabsItem
      ...
      style={{ 
        fontSize: "0.8rem",
        backgroundColor: activeTab === "tab1" || activeTab === "" ? "#ff0404" : "#292C35",
        color: "#FFFFFF",
    ...
    <TETabsItem
      ...
      style={{ 
        fontSize: "0.8rem",
        backgroundColor: activeTab === "tab2" ? "#ff0404" : "#292C35",
        color: "#FFFFFF",
        transition: "background-color 0.2s ease",
      }}
    >
    ...
    <TETabsItem
      ...
      style={{ 
        fontSize: "0.8rem",
        backgroundColor: activeTab === "tab3" ? "#ff0404" : "#292C35",
        color: "#FFFFFF",
        transition: "background-color 0.2s ease",
      }}
    >
    ...
    <TETabsItem
      ...
      style={{ 
        fontSize: "0.8rem",
        backgroundColor: activeTab === "tab4" ? "#ff0404" : "#292C35",
        color: "#FFFFFF",
        transition: "background-color 0.2s ease",
