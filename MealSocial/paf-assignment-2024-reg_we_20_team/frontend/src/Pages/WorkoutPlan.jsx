    ...
    >
      ...
      <div className="space-y-4 flex justify-center flex-col items-center">
        {workoutPlans.map((workoutplans, index) => (
          <div
            key={index}
            className="shadow-lg bg-white rounded-lg p-4 w-[600px]" style={{ border: "2px solid #ff0404" }}
          >
            <div className="flex justify-between ">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold mb-2 text-neutral-700">
            ...
            <div>
              <div className="list-disc pl-5 space-y-1 mt-2">
                ...
                <p className="text-sm text-neutral-600">Sets: {workoutplans.sets}</p>
                <p className="text-sm text-neutral-600">
                  Repetitions: {workoutplans.repetitions}
                </p>
                <p className="text-sm text-neutral-600">Routine: {workoutplans.routine}</p>
                <p className="text-sm italic text-neutral-600">"{workoutplans.description}"</p>
              </div>
            </div>
          </div>
        ))}
