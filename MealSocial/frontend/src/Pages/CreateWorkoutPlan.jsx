    ...
    <Layout>
      ...
      >
        <form
          ...
          className="max-w-xl mx-auto bg-black p-6 rounded-lg shadow-md " 
          style={{ backgroundColor: "white" }}
          
        >
          <h1 className="mb-4 text-3xl font-semibold text-center text-indigo-600" style={{ color: "#FF0404" }}>
            {editWorkoutPlans ? "Edit Workout Plan" : "Create Workout Plan"}
          </h1>
          <div className="text-center mb-4" style={{ color: "#FF0404" }}>Please select your Routine</div>
          <div className="space-y-8">
            <div className="mb-4">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 border border-black rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 bg-white text-neutral-500"
              ...
              <div className="mb-4">
                <label
                  htmlFor="exercises"
                  className="block text-sm font-medium text-neutral-500 items-center"
                >
                  Excercise Name
                </label>
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 bg-white text-neutral-500"
            ...
            <div className="relative max-w-sm">
              ...
              <input
                ...
                className="bg-gray-800 border border-gray-300 text-neutral-500 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <button
            type="submit"
            className="w-full mt-6 px-4 py-2 text-sm font-medium text-white bg-red-700 rounded-md shadow hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2"
          >
            Submit Workout
          </button>
          <button
