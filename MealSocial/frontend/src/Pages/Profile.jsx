  ...
  return (
    <Layout>
      ...
      >
        ...
        <div className="w-[800px] bg-black rounded-lg">
          <section>
            <img
              className="w-full h-64 object-cover"
              src="https://i.pinimg.com/736x/c4/2a/8c/c42a8c23165aa07f0b072a957379805d.jpg"
              alt=""
            />
          </section>
            ...
            <div className="flex justify-between items-start mt-5 h-20 ">
              ...
              <div className="pl-4">
                {loginUser?.id !== user?.id ? (
                  ...
                  <button
                    className="bg-red-700 hover:bg-red-500 text-white px-8 py-2 rounded-3xl space-x-3 "
            ...
            <div className="mt-2 space-y-3">
              ...
              {loginUser?.id !== user?.id ? null : (
                <div className="flex items-center space-x-12 pb-4">
                  <NavLink
                    to="/post"
                    className="bg-red-700 hover:bg-red-500 text-white px-15 py-2 rounded-md text-center"
                    style={{ width: "150px" }}
                  >
                    Post
                  </NavLink>
